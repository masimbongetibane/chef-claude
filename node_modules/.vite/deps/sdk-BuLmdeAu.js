...
async function checkCredentialsFileSafety(path, onWarn = (m) => console.warn(`anthropic-sdk: ${m}`)) {
	...
	const fs = await import("./browser-external_node_fs-Cs2ukOUy.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	let resolved = path;
	let st;
	try {
...
async function writeCredentialsFileAtomic(targetPath, data) {
	const fs = await import("./browser-external_node_fs-Cs2ukOUy.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const dir = (await import("./browser-external_node_path-Bc6EWbB_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).dirname(targetPath);
...
var loadConfigWithSource = async (profile) => {
	...
	const fs = await import("./browser-external_node_fs-Cs2ukOUy.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const configPath = (await import("./browser-external_node_path-Bc6EWbB_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).join(rootConfigPath, "configs", `${profileName}.json`);
	let configRaw;
	try {
...
var getCredentialsPath = async (config, profile) => {
	...
	validateProfileName(profileName);
	return (await import("./browser-external_node_path-Bc6EWbB_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).join(rootConfigPath, "credentials", `${profileName}.json`);
};
var getRootConfigPath = async () => {
	if (!supportsLocalConfigFiles()) return null;
	const path = await import("./browser-external_node_path-Bc6EWbB_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
var getActiveProfileName = async () => {
	...
	const fs = await import("./browser-external_node_fs-Cs2ukOUy.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const filePath = (await import("./browser-external_node_path-Bc6EWbB_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).join(rootConfigPath, "active_config");
	try {
		...
		try {
			resp = await config.fetch(url, {
				...
				headers: {
					...
					"User-Agent": config.userAgent || `anthropic-sdk-typescript/0.99.0 oidcFederationProvider`
				},
				body: JSON.stringify(body)
			});
		} catch (err) {
		...
		try {
			resp = await config.fetch(url, {
				...
				headers: {
					...
					"User-Agent": config.userAgent || `anthropic-sdk-typescript/0.99.0 userOAuthProvider`
				},
				body: JSON.stringify(body)
			});
		} catch (err) {
...
_EnvironmentWorker_signal = /* @__PURE__ */ new WeakMap(), _EnvironmentWorker_instances = /* @__PURE__ */ new WeakSet(), _EnvironmentWorker_handleItem = async function _EnvironmentWorker_handleItem(work, environmentKey, externalSignal) {
	...
	const agentToolset = await import("./node-Ds5XaTmj.js");
...
//# sourceMappingURL=sdk-BuLmdeAu.js.map